...
const meta = {
  title: 'App/Attendance/Member Attendance History Panel',
...
export const WithAttendanceHistory: Story = {
  args: {
    memberId: 'member-001',
...
export const EmptyAttendanceHistory: Story = {
  args: {
    memberId: 'member-003',
    attendances: sampleAttendanceRecords,
  },
...
export const SingleAttendanceRecord: Story = {
  args: {
    memberId: 'member-002',
    attendances: sampleAttendanceRecords,
  },
